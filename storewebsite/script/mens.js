...
var mensData = [
 ...
 for(let i=0;i<mensData.length;i++)
 {
     ...
     div.setAttribute("class", "innerone");
     let img = document.createElement("img");
     img.src =
       "https://media.istockphoto.com/id/1335845017/photo/pink-blooming-lotus-close-up.jpg?s=1024x1024&w=is&k=20&c=cfd4sF8c16DfhB2FBwVcs5jE_Wk6xQy8e4bU4uuJD0I=";
     let name = document.createElement("h3");
     name.textContent = mensData[i].name;
     let price = document.createElement("h4");
     let button = document.createElement("button")
     button.textContent = "Add to Cart";
     price.textContent = "Rs. " + mensData[i].price;
...
function display(data) {
  ...
  //    nam.textContent = mensData[i].name;
  //    let price = document.createElement("h3")
  //    price.textContent = "Price: " + mensData[i].price;
